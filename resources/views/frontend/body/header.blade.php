          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                @if(session()->get('language') =='hindi') होम   @else Home  @endif 
                </a> </li>
              @php
              ...
              @foreach($subcategories as $subcategory)
                          ...
                          <a href="{{ url('subcategory/product/'.$subcategory->id.'/'.$subcategory->sub_category_slug_en) }}"><h2 class="title">
              ...
              @foreach($subsubcategories as $subsubcategory)
                            <ul class="links">
                              ...
                              <li><a href="{{ url('subsubcategory/product/'.$subsubcategory->id.'/'.$subsubcategory->subsub_category_slug_en) }}">
                              @if(session()->get('language') =='hindi')  {{ $subsubcategory->subsub_category_name_hin }}   @else  {{ $subsubcategory->subsub_category_name_en }}  @endif  
