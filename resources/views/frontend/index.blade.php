        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
          <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
              ...
              <li><a data-transition-type="backSlide" href="#category{{ $cateogry->id }}" data-toggle="tab">
              @if(session()->get('language') =='hindi') {{ $cateogry->category_name_hin }}  @else {{ $cateogry->category_name_en }}  @endif
...
@foreach($categories as $cateogry)
            <div class="tab-pane" id="category{{ $cateogry->id }}">
              <div class="product-slider">
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
  @php 
$catwiseProduct = App\Models\Product::where('category_id', $cateogry->id)->orderBy('id', 'DESC')->get();
  ...
  @endphp
                @forelse($catwiseProduct as $product)
                  ...
                  <!-- /.item -->
                  @empty
                  <h3 class="text-danger">Product Not Found in This category</h3>
                  @endforelse
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              ...
                              <button  id="{{ $product->id }}" onclick="addToWhistlist(this.id)" class="btn btn-primary icon" type="button" title="Add Cart"> <i class="fa fa-heart"></i> </button>
