					  ...
					  <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($coupons as $item)
							<tr>
								...
								<td width="20%"><a title="Edit Data"  class="btn btn-info" href="{{ route('coupon.edit',$item->id) }}"><i class="fa fa-pencil"></i></a> &nbsp;&nbsp; <a title="Delete Data" class="btn btn-danger" href="{{ route('coupon.delete',$item->id) }}" id="delete" ><i class="fa fa-trash"></i></a></td>
