...
<div class="row"> <!-- start 4th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_size_hin" class="form-control" value="" data-role="tagsinput" required>
	 ...
	 <div class="row" id="previewimg"></div>
		...
		<div class="row"> <!-- start 7th row  -->
			...
			<div class="controls">
				<textarea name="short_descp_en" id="text-area" class="form-control" required placeholder="Textarea text"></textarea>
	 ...
	 @enderror
			...
			<div class="controls">
				<textarea name="short_descp_hin" id="text-area" class="form-control" required placeholder="Textarea text"></textarea>
	 ...
	 @enderror
		...
		<div class="row"> <!-- start 8th row  -->
			...
			<div class="form-group">
				...
				<div class="controls">
					<fieldset>
						<input type="checkbox" id="checkbox_2" required value="1" name="hot_deals">
			...
			<div class="form-group">
				...
				<div class="controls">
					<fieldset>
						<input type="checkbox" id="checkbox_4" required value="1" name="special_offer">
