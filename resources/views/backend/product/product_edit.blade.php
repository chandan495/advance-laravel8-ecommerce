 ...
 <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected' : '' }}>{{ $subsub->subsub_category_name_en }}</option>	
	 ...
	 @enderror
		...
		<div class="form-group">
			...
			<div class="controls">
				<input type="text" value="{{ $products->product_name_hin }}" name="product_name_hin" class="form-control" required>
...
<div class="row"> <!-- start 4th row  -->
	 ...
	 @enderror
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="discount_price" value="{{ $products->discount_price }}"  class="form-control" value="" >
...
@enderror
		...
		<div class="row"> <!-- start 7th row  -->
			...
			<div class="controls">
				<textarea name="short_descp_en" id="text-area" class="form-control" required >{{ $products->short_descp_en }}</textarea>
	 ...
	 @enderror
			...
			<div class="controls">
				<textarea name="short_descp_hin" id="text-area" class="form-control" required placeholder="Textarea text">{{ $products->short_descp_hin }}</textarea>
	 ...
	 @enderror
		...
		<div class="row"> <!-- start 7th row  -->
			...
			<div class="controls">
				<textarea name="long_descp_en" id="editor1" class="form-control" required placeholder="Textarea text">{{ $products->long_descp_en }}</textarea>
				@error('long_descp_en') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
			</div>
			...
			<div class="controls">
				<textarea name="long_descp_hin" id="editor2" class="form-control" required placeholder="Textarea text">{{ $products->long_descp_hin }}</textarea>
	 ...
	 @enderror
		...
		<div class="row"> <!-- start 8th row  -->
			...
			<div class="form-group">
				...
				<div class="controls">
					<fieldset>
						<input type="checkbox"  id="checkbox_2" required value="1" name="hot_deals" {{ $products->hot_deals == 1 ? 'checked' : '' }}>
						<label for="checkbox_2">Hot Deals</label>
					</fieldset>
					<fieldset>
						<input type="checkbox" id="checkbox_3" value="1" name="featured" {{ $products->featured == 1 ? 'checked' : '' }}>
			...
			<div class="form-group">
				...
				<div class="controls">
					<fieldset>
						<input type="checkbox" id="checkbox_4" required value="1" name="special_offer" {{ $products->special_offer == 1 ? 'checked' : '' }} >
